...
import { accounts, fetchAccounts, resetAccountStatus } from '../../features/account/accountSlice'
    ...
    <section>
      ...
      <SectionContainer extraStyles={' overflow-x-auto items-center'}>
        ...
        {accountList.length > 0 && <div className='flex flex-col sm:flex-row sm:flex-wrap justify-center'>
          <div className='text-sm sm:text-xl p-2 bg-gray-200 rounded-xl flex gap-2'>
